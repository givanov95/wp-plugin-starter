...
class SubMenuPage extends Page
{
    ...
    {
        $mainPageSlug =  $this->mainPageClass ? $this->mainPageClass?->getSlug() : "";
    ...
    public function enqueue_assets()
    {
        ...
        if (file_exists($manifest) && $manifestContent = file_get_contents($manifest)) {
