...
{
    protected string $pageTitle = 'Categoeries';

    protected string $menuTitle = 'Categories';
     ...
     * @var string
     */
    protected string $slug = 'forms-settings';

    protected string $callback = 'renderCategories';
